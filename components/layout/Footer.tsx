    ...
    <footer className="bg-tertiary">
      <div className="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500 dark:text-gray-400">
          30 años promoviendo el fútbol y la cultura latinoamericana en Berlín.
        </p>
        ...
        <ul className="my-12 flex justify-center gap-6 md:gap-8">
          <li>
            <a
              href="https://www.facebook.com/Clubdeportivolatinoberlin"
              rel="noreferrer"
              target="_blank"
              className="text-gray-700 transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75"
            >
          ...
          <li>
            <a
              href="https://www.instagram.com/clubdeportivolatino"
              rel="noreferrer"
              target="_blank"
              className="text-gray-700 transition hover:text-gray-700/75 dark:text-white dark:hover:text-white/75"
            >
